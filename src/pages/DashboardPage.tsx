    ...
    <>
      ...
      <div className={css.dashGrid2}>
        <Card>
          ...
          <Bars height={190} data={[
            { label: 'Lun', value: 288 }, { label: 'Mar', value: 342 }, { label: 'Mie', value: 315 },
            { label: 'Jue', value: 371 }, { label: 'Vie', value: 412 }, { label: 'Sab', value: 389 }, { label: 'Dom', value: 214 },
          ]} />
        </Card>
        <Card>
          <div className={css.chartHeaderSolo}>Gasto por categoria</div>
          <Donut
            segments={[{ label: 'Combustible', value: 182 }, { label: 'Peaje', value: 41 }, { label: 'Mantenimiento', value: 25 }]}
            centerValue="$248k"
            centerLabel="Total"
            legend
          />
      ...
      <Card>
        ...
        <FlowChart
          ...
          series={[
            { label: 'Combustible', values: [52, 70, 40, 60] },
            { label: 'Peaje', values: [18, 10, 12, 22] },
            { label: 'Mantenimiento', values: [20, 15, 18, 14] },
            { label: 'Electromovilidad', values: [10, 5, 30, 4] },
          ]}
      ...
      <Card style={{ marginTop: 16 }}>
        ...
        <div className={css.chartDesc}>7 unidades activas — click en un pin para ver detalle</div>
        <MapCanvas
          center={[19.4326, -99.1332]}
          zoom={12}
          pins={[
            { id: 'JMX-214', lat: 19.4360, lon: -99.1540, label: 'JMX-214' },
            { id: 'KTR-882', lat: 19.4190, lon: -99.1680, label: 'KTR-882', color: '#ef4444' },
            { id: 'MVD-101', lat: 19.4450, lon: -99.1200, label: 'MVD-101' },
            { id: 'PLQ-472', lat: 19.4100, lon: -99.1400, label: 'PLQ-472' },
            { id: 'QRS-330', lat: 19.4280, lon: -99.1900, label: 'QRS-330' },
            { id: 'TWN-559', lat: 19.4510, lon: -99.1350, label: 'TWN-559' },
            { id: 'BNM-220', lat: 19.4380, lon: -99.1070, label: 'BNM-220' },
          ]}
          route={[
      ...
      <div className={css.dashGrid2}>
        <Card>
          ...
          <Bars height={180} data={[
            { label: 'JMX-214', value: 9.1 }, { label: 'KTR-882', value: 14.8 },
        ...
        <Card>
          ...
          <FlowChart
            ...
            series={[
              { label: 'Gasto ($k)', values: [38, 42, 40, 45, 44, 47, 46] },
              { label: '$/L', values: [22.4, 22.6, 22.9, 23.1, 23.0, 23.2, 23.0] },
            ]}
    ...
    <>
      ...
      <div className={css.dashGrid2eq}>
        <Card>
          ...
          <Donut
            segments={[{ label: 'Preventivo', value: 11 }, { label: 'Correctivo', value: 9 }, { label: 'Llantas', value: 5.3 }]}
            centerValue="$25.3k"
            centerLabel="Mes"
            legend
          />
      ...
      <Card>
        ...
        <GanttChart tasks={[
          { id: 'm1', name: 'MVD-101 · Servicio 40k', start: '2026-08-15', end: '2026-08-18', progress: 80 },
          { id: 'm2', name: 'KTR-882 · Balatas', start: '2026-08-20', end: '2026-08-22', progress: 0 },
          { id: 'm3', name: 'JMX-214 · Rotación llantas', start: '2026-08-25', end: '2026-08-26', progress: 0 },
          { id: 'm4', name: 'QRS-330 · Servicio 20k', start: '2026-09-01', end: '2026-09-04', progress: 0 },
        ]} />
      </Card>
      <Card style={{ marginTop: 16 }}>
    ...
    <>
      ...
      <div className={css.dashGrid2}>
        <Card>
          ...
          <Bars height={180} data={[
            { label: 'Polanco', value: 64 }, { label: 'Condesa', value: 48 },
            { label: 'Anzures', value: 31 }, { label: 'Del Valle', value: 26 }, { label: 'Base', value: 17 },
          ]} />
        </Card>
        <Card>
          ...
          <Donut
            segments={[
              { label: 'Combustion', value: 96 },
              { label: 'Electricas', value: 24 },
              { label: 'Hibridas', value: 8 },
            ]}
            centerValue="128"
    ...
    <>
      ...
      <div className={css.dashGrid2}>
        <Card>
          ...
          <Bars height={180} data={[
            { label: 'Tepotzotlan', value: 12.4 }, { label: 'San Marcos', value: 8.9 },
            { label: 'Ecatepec', value: 7.2 }, { label: 'Chalco', value: 6.8 }, { label: 'Otras', value: 5.8 },
          ]} />
        </Card>
        <Card>
      ...
      <div className={css.dashGrid2}>
        <Card>
          ...
          <FlowChart
            ...
            series={[
              { label: 'Ingreso', values: [540, 571, 558, 590, 601, 612] },
              { label: 'Costo', values: [262, 255, 270, 259, 258, 248] },
            ]}
